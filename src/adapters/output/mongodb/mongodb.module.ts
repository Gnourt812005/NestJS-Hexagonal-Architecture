...
@Module({
  imports: [
    MongooseModule.forRoot(
      process.env.MONGODB_URI as string || "mongodb+srv://txt812005:todolist@db-todolist.4enkypn.mongodb.net/image?retryWrites=true&w=majority&appName=db-todolist"
    ),
